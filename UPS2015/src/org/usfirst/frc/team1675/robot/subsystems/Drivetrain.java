	...
	public Drivetrain() {
		{
			...
			VictorSP frontLeftVSP = new VictorSP(
...

		{
			...
			VictorSP frontRightVSP = new VictorSP(
					RobotMap.PWMChannels.FRONT_RIGHT_DRIVE);
...

		{
			...
			VictorSP backLeftVSP = new VictorSP(
					RobotMap.PWMChannels.BACK_LEFT_DRIVE);
...

		{
			...
			VictorSP backRightVSP = new VictorSP(
					RobotMap.PWMChannels.BACK_RIGHT_DRIVE);
